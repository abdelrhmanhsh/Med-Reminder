...
public class DialogReceiver extends BroadcastReceiver {
    ...
    public static final String TAG = "DialogReceiver";
    Context context;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Intent incomingIntent = new Intent(context, NotificationDialogActivity.class);
        ...
        context.unregisterReceiver(MyWorkManager.dialogReceiver);
