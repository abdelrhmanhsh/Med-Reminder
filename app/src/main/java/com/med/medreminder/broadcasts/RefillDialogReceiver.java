...
import com.med.medreminder.ui.dialogs.RefillDialogActivity;
...
public class RefillDialogReceiver extends BroadcastReceiver {

    public static final String TAG = "RefillDialogReceiver";
    Context context;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Intent incomingIntent = new Intent(context, RefillDialogActivity.class);
        ...
        context.unregisterReceiver(RefillReminder.refillReceiver);
